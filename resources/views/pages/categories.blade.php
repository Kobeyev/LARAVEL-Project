...
<div class="super_container">
				...
				<ul class="page_menu_nav menu_mm">
					<li class="page_menu_item has-children menu_mm">
						...
						<ul class="page_menu_selection menu_mm">
							<li class="page_menu_item menu_mm"><a href="{{ route('categories') }}">Categories<i class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item menu_mm"><a href="{{ route('product') }}">Product<i class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item menu_mm"><a href="{{ route('cart') }}">Cart<i class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item menu_mm"><a href="{{ route('checkout') }}">Checkout<i class="fa fa-angle-down"></i></a></li>
					...
					<li class="page_menu_item has-children menu_mm">
						...
						<ul class="page_menu_selection menu_mm">
							<li class="page_menu_item menu_mm"><a href="{{ route('categories') }}">Category<i class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item menu_mm"><a href="{{ route('categories') }}">Category<i class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item menu_mm"><a href="{{ route('categories') }}">Category<i class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item menu_mm"><a href="{{ route('categories') }}">Category<i class="fa fa-angle-down"></i></a></li>
						</ul>
	...
	<div class="home">
		<div class="home_container">
            @foreach($cats as $cat)
                <div class="home_background"><img src="{{ 'http://127.0.0.1:8000/storage/' . $cat->image}}" ></div>
                <div class="home_content_container">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="home_content">
                                    <div class="home_title"><h>{{ $cat->title  }}</h><span>.</span></div>
                                    <div class="home_text"><p>{{ $cat ->subtitle }}</p></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    {{--                                    <div class="product_image"><img src="{{ 'http://127.0.0.1:8000/storage/' . $el->image}}" alt=""></div>--}}
    {{--                                    <div class="product_extra product_new"><a href="{{ route('categories') }}">{{$el->category_id}}</a></div>--}}
    {{--                                    <div class="product_content">--}}
    {{--                                        <div class="product_title"><a href="{{ route('product') }}"><h3>{{ $el->title  }}</h3></a></div>--}}
    {{--                                        <div class="product_price"><a>${{ $el->price }}</a></div>--}}
    {{--                                    </div>--}}
    {{--                                @endforeach--}}
    {{--                            @else--}}
    {{--                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque dolor eveniet laboriosam nostrum, numquam totam velit? Assumenda debitis eos et ex explicabo hic, incidunt maxime nesciunt perspiciatis, repellat rerum soluta.</p>--}}
    {{--                            @endif--}}
    {{--                        </div>--}}
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="images/product_2.jpg" alt=""></div>
							<div class="product_extra product_sale"><a href="{{ route('categories') }}">Sale</a></div>
							<div class="product_content">
						...
						<div class="product">
							...
							<div class="product_extra product_hot"><a href="{{ route('categories') }}">Hot</a></div>
							<div class="product_content">
								<div class="product_title"><a href="{{ route('product') }}">Smart Phone</a></div>
						...
						<div class="product">
							...
							<div class="product_extra product_sale"><a href="{{ route('categories') }}">Hot</a></div>
							<div class="product_content">
								<div class="product_title"><a href="{{ route('product') }}">Smart Phone</a></div>
