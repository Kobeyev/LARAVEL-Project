			...
			<div class="row details_row">
				...
				<div class="col-lg-6">
					<div class="details_image">
						<div class="details_image_large"><img src="images/details_1.jpg" alt=""><div class="product_extra product_new"><a href="{{ route('categories') }}">New</a></div></div>
                    ...
                    <div class="product_grid">
                        @if($products)
                            @foreach($products as $el)
                                <div class="product">
                                    <a href="{{route('cart',['id'=>$el->id])}}">
                                        <div class="product_image"><img src="{{ 'http://127.0.0.1:8000/storage/' . $el->image}}" alt=""></div>
                                        <div class="product_extra product_sale"><a href="{{ route('categories') }}">{{$el->category_id}}</a></div>
