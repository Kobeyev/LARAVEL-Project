...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <link rel="stylesheet" type="text/css" href="../../../public/css/cart_responsive.css">
					...
					<div class="cart_item d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
						...
						<div class="cart_item_product d-flex flex-row align-items-center justify-content-start">
							<div class="cart_item_image">
								<div><img src="{{ 'http://127.0.0.1:8000/storage/' . $item->image}}" alt=""></div>
							</div>
							<div class="cart_item_name_container">
								<div class="cart_item_name"><a href="#">{{ $item->title }}</a></div>
								<div class="cart_item_edit"><a href="{{ route('product') }}">Изменить продукт</a></div>
							</div>
						</div>
						<!-- Price -->
